...
import org.example.a_creational.singleton.LazySingleton;
...
public class SingletonCall {
    ...
    private LazySingleton lazySingleton = LazySingleton.canExe();
    /**
    ...
    public String LazySingleton() { return lazySingleton.getPhone(); }
